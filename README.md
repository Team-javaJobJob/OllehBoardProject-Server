...
프로젝트 컨셉에 맞는 기획과 요구사항을 반영한 비즈니스 로직 구현 Rest api 서버 개발 프로젝트이며, 

프론트엔드와의 협업 및 서버 배포를 통해 실제 서비스를 운영하며 확장해나아갈 수 있는 프로젝트를 만들었습니다.


🙋‍♂️팀원 소개
-------------
- BackEnd : [조찬영](https://github.com/NinjaYoung98), [조동혁](https://github.com/donizz), [박지영](https://github.com/jiyoung10), [이나래](https://github.com/naraeeee), [박규현](https://github.com/henryKyuhyun)
